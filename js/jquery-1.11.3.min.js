!(function () {
  function e(e, t) {
    t.src
      ? h.ajax({ url: t.src, async: !1, dataType: "script" })
      : h.globalEval(t.text || t.textContent || t.innerHTML || ""),
  ...
  function o(e) {
    var t = RegExp("(^|\\.)" + e.type + "(\\.|$)"),
      ...
      r = [];
    return (
      h.each(h.data(this, "events").live || [], function (n, i) {
        if (t.test(i.type)) {
      ...
      h.each(r, function () {
        return this.fn.call(this.elem, e, this.fn.data) === !1
          ? (n = !1)
          : void 0;
      }),
      n
  ...
  function l(e, t) {
    var n = {};
    return (
      h.each(L.concat.apply([], L.slice(0, t)), function () {
        n[this] = e;
      }),
      n
    );
  ...
  (h.fn = h.prototype =
    {
      init: function (e, t) {
        ...
        return (
          ...
          this.setArray(h.isArray(e) ? e : h.makeArray(e))
        );
      },
      selector: "",
      jquery: "1.3.2",
      ...
      attr: function (e, t, n) {
        ...
        return this.each(function (t) {
          for (e in r)
            h.attr(n ? this.style : this, e, h.prop(this, r[e], n, t, e));
        });
      },
      css: function (e, t) {
        return (
          ("width" == e || "height" == e) && parseFloat(t) < 0 && (t = c),
      ...
      text: function (e) {
        ...
        var t = "";
        return (
          h.each(e || this, function () {
            h.each(this.childNodes, function () {
              8 != this.nodeType &&
                (t += 1 != this.nodeType ? this.nodeValue : h.fn.text([this]));
            });
          }),
          t
        );
      ...
      clone: function (e) {
        var t = this.map(function () {
          if (h.support.noCloneEvent || h.isXMLDoc(this))
          ...
          return h.clean([
            e.replace(/ jQuery\d+="(?:\d+|null)"/g, "").replace(/^\s*/, ""),
          ])[0];
        });
        if (e === !0) {
          ...
          t.find("*")
            ...
            .each(function () {
              if (this.nodeName === n[r].nodeName) {
                ...
                for (var t in e)
                  for (var i in e[t])
                    h.event.add(this, t, e[t][i], e[t][i].data);
                r++;
              }
            });
        }
      ...
      filter: function (e) {
        return this.pushStack(
          (h.isFunction(e) &&
            h.grep(this, function (t, n) {
              return e.call(t, n);
            })) ||
            h.multiFilter(
              e,
              h.grep(this, function (e) {
                return 1 === e.nodeType;
              })
            ),
          "filter",
      ...
      closest: function (e) {
        var t = h.expr.match.POS.test(e) ? h(e) : null,
          n = 0;
        return this.map(function () {
          for (var r = this; r && r.ownerDocument; ) {
            if (t ? t.index(r) > -1 : h(r).is(e))
              return h.data(r, "closest", n), r;
            (r = r.parentNode), n++;
          }
        });
      },
      not: function (e) {
        if ("string" == typeof e) {
          if (m.test(e))
            return this.pushStack(h.multiFilter(e, this, !0), "not", e);
      ...
      add: function (e) {
        return this.pushStack(
          h.unique(
            h.merge(this.get(), "string" == typeof e ? h(e) : h.makeArray(e))
          )
        );
      },
      is: function (e) {
      ...
      val: function (e) {
        ...
        return (
          ...
          this.each(function () {
            if (1 == this.nodeType)
              if (h.isArray(e) && /radio|checkbox/.test(this.type))
                this.checked =
                  h.inArray(this.value, e) >= 0 || h.inArray(this.name, e) >= 0;
              else if (h.nodeName(this, "select")) {
                var t = h.makeArray(e);
                h("option", this).each(function () {
                  this.selected =
                    h.inArray(this.value, t) >= 0 ||
                    h.inArray(this.text, t) >= 0;
                }),
      ...
      domManip: function (t, n, r) {
        function i(e, t) {
          return n && h.nodeName(e, "table") && h.nodeName(t, "tr")
        ...
        if (this[0]) {
          var o = (this[0].ownerDocument || this[0]).createDocumentFragment(),
            a = h.clean(t, this[0].ownerDocument || this[0], o),
            s = o.firstChild;
          if (s)
            for (var l = 0, c = this.length; c > l; l++)
              r.call(
                i(this[l], s),
                this.length > 1 || l > 0 ? o.cloneNode(!0) : o
              );
          a && h.each(a, e);
        }
        return this;
    ...
    (h.extend = h.fn.extend =
      function () {
        var e,
          ...
          i = !1;
        for (
          "boolean" == typeof t && ((i = t), (t = arguments[1] || {}), (n = 2)),
          ...
          if (null != (e = arguments[n]))
            for (var o in e) {
              var a = t[o],
                s = e[o];
              t !== s &&
                (i && s && "object" == typeof s && !s.nodeType
                  ? (t[o] = h.extend(i, a || (null != s.length ? [] : {}), s))
                  : s !== c && (t[o] = s));
            }
        return t;
      });
  ...
  h.extend({
    ...
    isXMLDoc: function (e) {
      return (
        (9 === e.nodeType && "HTML" !== e.documentElement.nodeName) ||
        (!!e.ownerDocument && h.isXMLDoc(e.ownerDocument))
      );
    },
    ...
    className: {
      ...
      has: function (e, t) {
        return (
          e && h.inArray(t, (e.className || e).toString().split(/\s+/)) > -1
        );
      },
    },
    swap: function (e, t, n) {
    ...
    css: function (e, t, n, r) {
      function i() {
        (o = "width" == t ? e.offsetWidth : e.offsetHeight),
          "border" !== r &&
            h.each(s, function () {
              r || (o -= parseFloat(h.curCSS(e, "padding" + this, !0)) || 0),
                "margin" === r
                  ? (o += parseFloat(h.curCSS(e, "margin" + this, !0)) || 0)
                  : (o -=
                      parseFloat(h.curCSS(e, "border" + this + "Width", !0)) ||
                      0);
            });
      }
      if ("width" == t || "height" == t) {
        ...
        return (
          0 !== e.offsetWidth ? i() : h.swap(e, a, i),
    ...
    curCSS: function (e, t, n) {
      var r,
        i = e.style;
      if ("opacity" == t && !h.support.opacity)
        return (r = h.attr(i, "opacity")), "" == r ? "1" : r;
      if ((t.match(/float/i) && (t = w), !n && i && i[t])) r = i[t];
      else if (v.getComputedStyle) {
        t.match(/float/i) && (t = "float"),
          (t = t.replace(/([A-Z])/g, "-$1").toLowerCase());
        var o = v.getComputedStyle(e, null);
        o && (r = o.getPropertyValue(t)),
          "opacity" == t && "" == r && (r = "1");
        ...
        if (
          ((r = e.currentStyle[t] || e.currentStyle[a]),
          !/^\d+(px)?$/i.test(r) && /^\d/.test(r))
        ) {
          var s = i.left,
            l = e.runtimeStyle.left;
    ...
    clean: function (e, t, n) {
      ...
      if (
            ...
            if ("string" == typeof n) {
              ...
              var r = n.replace(/^\s+/, "").substring(0, 10).toLowerCase(),
                o = (!r.indexOf("<opt") && [
                  ...
                  (!r.indexOf("<leg") && [1, "<fieldset>", "</fieldset>"]) ||
                  (r.match(/^<(thead|tbody|tfoot|colg|cap)/) && [
                    1,
                    "<table>",
                    "</table>",
                  ]) ||
                  ...
                  (!h.support.htmlSerialize && [1, "div<div>", "</div>"]) || [
                    0,
                    "",
                    "",
                  ];
        ...
        for (var s = 0; i[s]; s++)
          !h.nodeName(i[s], "script") ||
          (i[s].type && "text/javascript" !== i[s].type.toLowerCase())
            ? (1 === i[s].nodeType &&
                i.splice.apply(
                  i,
                  [s + 1, 0].concat(
                    h.makeArray(i[s].getElementsByTagName("script"))
                  )
                ),
              n.appendChild(i[s]))
            : o.push(
                i[s].parentNode ? i[s].parentNode.removeChild(i[s]) : i[s]
              );
        return o;
      }
      return i;
    ...
    attr: function (e, t, n) {
      ...
      if (((t = (r && h.props[t]) || t), e.tagName)) {
        ...
        if (
          ...
          if (i) {
            if ("type" == t && h.nodeName(e, "input") && e.parentNode)
              throw "type property can't be changed";
            e[t] = n;
          }
          if (h.nodeName(e, "form") && e.getAttributeNode(t))
            return e.getAttributeNode(t).nodeValue;
          if ("tabIndex" == t) {
            var a = e.getAttributeNode("tabIndex");
            return a && a.specified
              ? a.value
              : e.nodeName.match(/(button|input|object|select|textarea)/i)
              ? 0
              : e.nodeName.match(/^(a|area)$/i) && e.href
              ? 0
              : c;
          }
          return e[t];
        }
        if (!h.support.style && r && "style" == t)
          return h.attr(e.style, "cssText", n);
        i && e.setAttribute(t, "" + n);
        var s =
          !h.support.hrefNormalized && r && o
            ? e.getAttribute(t, 2)
            : e.getAttribute(t);
        return null === s ? c : s;
      }
      return h.support.opacity || "opacity" != t
        ...
        : (i &&
            ...
            (e.filter =
              ...
              (parseInt(n) + "" == "NaN"
                ? ""
                : "alpha(opacity=" + 100 * n + ")"))),
          e.filter && e.filter.indexOf("opacity=") >= 0
    ...
    h.each(
      ...
      function (e, t) {
        h.fn[e] = function (n) {
          var r = h.map(this, t);
          return (
            n && "string" == typeof n && (r = h.multiFilter(n, r)),
            this.pushStack(h.unique(r), e, n)
          );
        };
      }
    ),
    ...
    h.each(
      {
        ...
        toggleClass: function (e, t) {
          "boolean" != typeof t && (t = !h.className.has(this, e)),
            h.className[t ? "add" : "remove"](this, e);
        },
        remove: function (e) {
          (!e || h.filter(e, [this]).length) &&
            (h("*", this)
              .add([this])
              .each(function () {
        ...
        empty: function () {
          for (h(this).children().remove(); this.firstChild; )
  ...
  h.extend({
    ...
    h.fn.extend({
      data: function (e, t) {
        ...
        if (((n[1] = n[1] ? "." + n[1] : ""), t === c)) {
          ...
          return (
            r === c && this.length && (r = h.data(this[0], e)),
            r === c && n[1] ? this.data(n[0]) : r
          );
        }
    ...
    (function () {
      function e(e, t, n, r, i, o) {
        for (
          var a = "previousSibling" == e && !o, s = 0, l = r.length;
          l > s;
          s++
        ) {
          var c = r[s];
          if (c) {
            a && 1 === c.nodeType && ((c.sizcache = n), (c.sizset = s)),
              (c = c[e]);
            for (var u = !1; c; ) {
              if (c.sizcache === n) {
                u = r[c.sizset];
              ...
              if (
                (1 !== c.nodeType || o || ((c.sizcache = n), (c.sizset = s)),
                c.nodeName === t)
              ) {
                u = c;
                break;
      ...
      function t(e, t, n, r, i, a) {
        for (
          var s = "previousSibling" == e && !a, l = 0, c = r.length;
          c > l;
          l++
        ) {
          var u = r[l];
          if (u) {
            s && 1 === u.nodeType && ((u.sizcache = n), (u.sizset = l)),
              (u = u[e]);
            for (var d = !1; u; ) {
              if (u.sizcache === n) {
                d = r[u.sizset];
      ...
      var n =
        ...
        o = function (e, t, r, l) {
          ...
          if (y.length > 1 && s.exec(e))
            if (2 === y.length && a.relative[y[0]]) d = g(y[0] + y[1], t);
            else
              for (d = a.relative[y[0]] ? [t] : o(y.shift(), t); y.length; )
                (e = y.shift()),
                  a.relative[e] && (e += y.shift()),
                  (d = g(e, d));
          else {
            var x = l
              ? { expr: y.pop(), set: u(l) }
              : o.find(
                  y.pop(),
                  1 === y.length && t.parentNode ? t.parentNode : t,
                  m(t)
                );
            for (
              d = o.filter(x.expr, x.set), y.length > 0 ? (h = u(d)) : (b = !1);
              y.length;

            ) {
              var T = y.pop(),
                N = T;
              a.relative[T] ? (N = y.pop()) : (T = ""),
                null == N && (N = t),
                a.relative[T](h, N, m(t));
            }
          }
          if ((h || (h = d), !h))
            throw "Syntax error, unrecognized expression: " + (T || e);
          if ("[object Array]" === i.call(h))
            if (b)
              if (1 === t.nodeType)
                for (var E = 0; null != h[E]; E++)
                  h[E] &&
                    (h[E] === !0 || (1 === h[E].nodeType && p(t, h[E]))) &&
                    r.push(d[E]);
              else
                for (var E = 0; null != h[E]; E++)
                  h[E] && 1 === h[E].nodeType && r.push(d[E]);
            else r.push.apply(r, h);
          else u(h, r);
          if (
            v &&
            (o(v, t, r, l), f && ((hasDuplicate = !1), r.sort(f), hasDuplicate))
          )
            for (var E = 1; E < r.length; E++)
              r[E] === r[E - 1] && r.splice(E--, 1);
          return r;
        };
      (o.matches = function (e, t) {
        ...
        (o.filter = function (e, t, n, r) {
          for (
            var i, o, s = e, l = [], u = t, d = t && t[0] && m(t[0]);
            e && t.length;

          ) {
            for (var f in a.filter)
              if (null != (i = a.match[f].exec(e))) {
                var h,
                  p,
                  g = a.filter[f];
                if (((o = !1), u == l && (l = []), a.preFilter[f]))
                  if ((i = a.preFilter[f](i, u, n, l, r, d))) {
                    if (i === !0) continue;
                  } else o = h = !0;
                if (i)
                  for (var v = 0; null != (p = u[v]); v++)
                    if (p) {
                      h = g(p, i, v, u);
                      var y = r ^ !!h;
                      n && null != h
                ...
                if (h !== c) {
                  if ((n || (u = l), (e = e.replace(a.match[f], "")), !o))
                    return [];
                  break;
                }
              }
      ...
      var a = (o.selectors = {
            ...
            NAME: function (e, t, n) {
              if ("undefined" != typeof t.getElementsByName) {
                for (
                  ...
                  i[o].getAttribute("name") === e[1] && r.push(i[o]);
          ...
          preFilter: {
            CLASS: function (e, t, n, r, i, o) {
              ...
              for (var a, s = 0; null != (a = t[s]); s++)
                a &&
                  (i ^
                  (a.className && (" " + a.className + " ").indexOf(e) >= 0)
                    ? n || r.push(a)
                    : n && (t[s] = !1));
              return !1;
            },
          ...
          filters: {
            ...
            button: function (e) {
              return (
                "button" === e.type || "BUTTON" === e.nodeName.toUpperCase()
              );
            },
            input: function (e) {
          ...
          filter: {
            PSEUDO: function (e, t, n, r) {
              ...
              if ("not" === i) {
                for (var s = t[3], n = 0, l = s.length; l > n; n++)
                  if (s[n] === e) return !1;
                return !0;
              }
            },
        ...
        s = a.match.POS;
      for (var l in a.match)
        a.match[l] = RegExp(
          a.match[l].source + /(?![^\[]*\])(?![^\(]*\))/.source
        );
      var u = function (e, t) {
        return (
          ...
          (function () {
            ...
            (t.innerHTML = "<p class='TEST'></p>"),
              (t.querySelectorAll &&
                ...
                ((o = function (t, n, r, i) {
                  if (((n = n || document), !i && 9 === n.nodeType && !m(n)))
                    try {
      ...
      var p = document.compareDocumentPosition
          ? function (e, t) {
        ...
        m = function (e) {
          return (
            (9 === e.nodeType && "HTML" !== e.documentElement.nodeName) ||
            (!!e.ownerDocument && m(e.ownerDocument))
          );
        },
        g = function (e, t) {
          for (
            var n, r = [], i = "", s = t.nodeType ? [t] : t;
            (n = a.match.PSEUDO.exec(e));

          )
            (i += n[0]), (e = e.replace(a.match.PSEUDO, ""));
          e = a.relative[e] ? e + "*" : e;
      ...
      (h.find = o),
        ...
        (h.dir = function (e, t) {
          for (var n = [], r = e[t]; r && r != document; )
            1 == r.nodeType && n.push(r), (r = r[t]);
          return n;
        }),
    ...
    (h.event = {
      add: function (e, t, n, r) {
        if (3 != e.nodeType && 8 != e.nodeType) {
          ...
          var o = h.data(e, "events") || h.data(e, "events", {}),
            a =
              h.data(e, "handle") ||
              h.data(e, "handle", function () {
                return "undefined" == typeof h || h.event.triggered
                  ? c
                  : h.event.handle.apply(arguments.callee.elem, arguments);
              });
          (a.elem = e),
            h.each(t.split(/\s+/), function (t, i) {
              var s = i.split(".");
              (i = s.shift()), (n.type = s.slice().sort().join("."));
              var l = o[i];
              h.event.specialAll[i] &&
                h.event.specialAll[i].setup.call(e, r, s),
                l ||
                  ((l = o[i] = {}),
                  (h.event.special[i] &&
                    h.event.special[i].setup.call(e, r, s) !== !1) ||
                    (e.addEventListener
                      ? e.addEventListener(i, a, !1)
                      : e.attachEvent && e.attachEvent("on" + i, a))),
                (l[n.guid] = n),
                (h.event.global[i] = !0);
            }),
            (e = null);
      ...
      remove: function (e, t, n) {
        if (3 != e.nodeType && 8 != e.nodeType) {
          var r,
            i = h.data(e, "events");
          if (i) {
            if (t === c || ("string" == typeof t && "." == t.charAt(0)))
              for (var o in i) this.remove(e, o + (t || ""));
            else
              t.type && ((n = t.handler), (t = t.type)),
                h.each(t.split(/\s+/), function (t, o) {
                  var a = o.split(".");
                  o = a.shift();
                  var s = RegExp(
                    "(^|\\.)" + a.slice().sort().join(".*\\.") + "(\\.|$)"
                  ...
                  if (i[o]) {
                    if (n) delete i[o][n.guid];
                    else
                      for (var l in i[o])
                        s.test(i[o][l].type) && delete i[o][l];
                    h.event.specialAll[o] &&
                      h.event.specialAll[o].teardown.call(e, a);
                    for (r in i[o]) break;
                    r ||
                      ((h.event.special[o] &&
                        h.event.special[o].teardown.call(e, a) !== !1) ||
                        (e.removeEventListener
                          ? e.removeEventListener(o, h.data(e, "handle"), !1)
                          : e.detachEvent &&
                            e.detachEvent("on" + o, h.data(e, "handle"))),
                      (r = null),
                      delete i[o]);
                  }
                });
            ...
            if (!r) {
              ...
              a && (a.elem = null),
                h.removeData(e, "events"),
                h.removeData(e, "handle");
            }
          }
        }
      },
            ...
            n ||
              ...
              this.global[i] &&
                h.each(h.cache, function () {
                  this.events &&
                    this.events[i] &&
                    h.event.trigger(e, t, this.handle.elem);
                })),
      ...
      handle: function (e) {
        var t, n;
        (e = arguments[0] = h.event.fix(e || u.event)),
      ...
      fix: function (e) {
        ...
        var t = e;
        e = h.Event(t);
        for (var n, r = this.props.length; r; )
          (n = this.props[--r]), (e[n] = t[n]);
        if (
    ...
    h.fn.extend({
      ...
      live: function (e, t) {
        ...
        return (
          ...
          h(document).bind(a(e, this.selector), this.selector, n),
          this
        );
      },
      die: function (e, t) {
    ...
    h.extend({
      ...
      ready: function () {
        h.isReady ||
          ((h.isReady = !0),
          h.readyList &&
            (h.each(h.readyList, function () {
              this.call(document, h);
            }),
            (h.readyList = null)),
          h(document).triggerHandler("ready"));
      },
    });
  var S = !1;
  h.each(
    ...
    h(u).bind("unload", function () {
      for (var e in h.cache)
        1 != e && h.cache[e].handle && h.event.remove(h.cache[e].handle.elem);
    }),
    (function () {
      h.support = {};
      ...
      if (i && i.length && o) {
        ...
        e.insertBefore(t, e.firstChild),
          u[r] && ((h.support.scriptEval = !0), delete u[r]),
          e.removeChild(t),
          n.attachEvent &&
            n.fireEvent &&
            (n.attachEvent("onclick", function () {
              (h.support.noCloneEvent = !1),
          ...
          h(function () {
            ...
            (e.style.width = e.style.paddingLeft = "1px"),
              ...
              (h.boxModel = h.support.boxModel = 2 === e.offsetWidth),
    ...
    h.fn.extend({
      ...
      load: function (e, t, n) {
        ...
        t &&
          (h.isFunction(t)
            ? ((n = t), (t = null))
            : "object" == typeof t && ((t = h.param(t)), (o = "POST")));
        var a = this;
        return (
          h.ajax({
            url: e,
  ...
  h.extend({
    get: function (e, t, n, r) {
      return (
        h.isFunction(t) && ((n = t), (t = null)),
        h.ajax({ type: "GET", url: e, data: t, success: n, dataType: r })
      );
    },
    ...
    post: function (e, t, n, r) {
      return (
        h.isFunction(t) && ((n = t), (t = {})),
        h.ajax({ type: "POST", url: e, data: t, success: n, dataType: r })
      );
    },
    ...
    ajax: function (e) {
      function n() {
        e.success && e.success(a, o),
          e.global && h.event.trigger("ajaxSuccess", [b, e]);
      }
      function r() {
        e.complete && e.complete(b, o),
          e.global && h.event.trigger("ajaxComplete", [b, e]),
          e.global && !--h.active && h.event.trigger("ajaxStop");
      }
      ...
      var i,
        ...
        a,
        s = /=\?(&|$)/g,
        l = e.type.toUpperCase();
      if (
        (e.data &&
          e.processData &&
          "string" != typeof e.data &&
          (e.data = h.param(e.data)),
        "jsonp" == e.dataType &&
          ("GET" == l
            ? e.url.match(s) ||
              (e.url +=
          ...
          (e.dataType = "json")),
        "json" == e.dataType &&
          ((e.data && e.data.match(s)) || e.url.match(s)) &&
          ((i = "jsonp" + C++),
          e.data && (e.data = (e.data + "").replace(s, "=" + i + "$1")),
          (e.url = e.url.replace(s, "=" + i + "$1")),
          (e.dataType = "script"),
          (u[i] = function (e) {
            (a = e), n(), r(), (u[i] = c);
            try {
        ...
        "script" == e.dataType && null == e.cache && (e.cache = !1),
        e.cache === !1 && "GET" == l)
      ) {
        var d = t(),
          f = e.url.replace(/(\?|&)_=.*?(&|$)/, "$1_=" + d + "$2");
        e.url =
          f + (f == e.url ? (e.url.match(/\?/) ? "&" : "?") + "_=" + d : "");
      }
      e.data &&
        "GET" == l &&
        ((e.url += (e.url.match(/\?/) ? "&" : "?") + e.data), (e.data = null)),
        e.global && !h.active++ && h.event.trigger("ajaxStart");
      var p = /^(\w+:)?\/\/([^\/?#]+)/.exec(e.url);
      if (
        "script" == e.dataType &&
        "GET" == l &&
        ...
        if (
          ((g.src = e.url),
          e.scriptCharset && (g.charset = e.scriptCharset),
          !i)
        ) {
          var v = !1;
      ...
      var y = !1,
        b = e.xhr();
      e.username
        ? b.open(l, e.url, e.async, e.username, e.password)
        : b.open(l, e.url, e.async);
      try {
        e.data && b.setRequestHeader("Content-Type", e.contentType),
          e.ifModified &&
            b.setRequestHeader(
              "If-Modified-Since",
              h.lastModified[e.url] || "Thu, 01 Jan 1970 00:00:00 GMT"
            ),
      ...
      var T = function (t) {
        if (0 == b.readyState)
          N &&
            ...
            (N = null),
            e.global && !--h.active && h.event.trigger("ajaxStop"));
        else if (!y && b && (4 == b.readyState || "timeout" == t)) {
          if (
            ((y = !0),
            ...
            (o =
              "timeout" == t
                ? "timeout"
                : h.httpSuccess(b)
                ? e.ifModified && h.httpNotModified(b, e.url)
                  ? "notmodified"
                  : "success"
                : "error"),
            "success" == o)
    ...
    handleError: function (e, t, n, r) {
      e.error && e.error(t, n, r),
        e.global && h.event.trigger("ajaxError", [t, e, r]);
    },
    active: 0,
  ...
  h.fn.extend({
    show: function (e, t) {
      ...
      for (var n = 0, r = this.length; r > n; n++) {
        ...
        if (
          ((this[n].style.display = i || ""),
          "none" === h.css(this[n], "display"))
        ) {
          var o,
            a = this[n].tagName;
          if (D[a]) o = D[a];
      ...
      for (var n = 0, r = this.length; r > n; n++)
        this[n].style.display = h.data(this[n], "olddisplay") || "";
      return this;
    },
    hide: function (e, t) {
      ...
      for (var n = 0, r = this.length; r > n; n++) {
        ...
        i ||
          "none" === i ||
          h.data(this[n], "olddisplay", h.css(this[n], "display"));
      }
      for (var n = 0, r = this.length; r > n; n++)
    ...
    toggle: function (e, t) {
      ...
      return h.isFunction(e) && h.isFunction(t)
      ...
      speed: function (e, t, n) {
        ...
        return (
          (r.duration = h.fx.off
            ...
            ? r.duration
            : h.fx.speeds[r.duration] || h.fx.speeds._default),
          (r.old = r.complete),
          (r.complete = function () {
            r.queue !== !1 && h(this).dequeue(),
    ...
    (h.fx.prototype = {
      ...
      cur: function (e) {
        ...
        return t && t > -1e4
          ? t
          : parseFloat(h.curCSS(this.elem, this.prop)) || 0;
      },
        ...
        (i.elem = this.elem),
          i() &&
            ...
            (A = setInterval(function () {
              for (var e = h.timers, t = 0; t < e.length; t++)
                e[t]() || e.splice(t--, 1);
              e.length || (clearInterval(A), (A = c));
            }, 13));
      },
      show: function () {
        (this.options.orig[this.prop] = h.attr(this.elem.style, this.prop)),
          (this.options.show = !0),
          this.custom(
      ...
      step: function (e) {
        ...
        if (e || n >= this.options.duration + this.startTime) {
          ...
          for (var i in this.options.curAnim)
            this.options.curAnim[i] !== !0 && (r = !1);
          if (r) {
            if (
              (null != this.options.display &&
                ((this.elem.style.overflow = this.options.overflow),
                (this.elem.style.display = this.options.display),
                "none" == h.css(this.elem, "display") &&
                  (this.elem.style.display = "block")),
              this.options.hide && h(this.elem).hide(),
              this.options.hide || this.options.show)
            )
              for (var o in this.options.curAnim)
                h.attr(this.elem.style, o, this.options.orig[o]);
        ...
        return (
          ...
          (this.pos = h.easing[
            this.options.easing || (h.easing.swing ? "swing" : "linear")
    ...
    document.documentElement.getBoundingClientRect
      ? (h.fn.offset = function () {
          ...
          if (this[0] === this[0].ownerDocument.body)
            return h.offset.bodyOffset(this[0]);
          var e = this[0].getBoundingClientRect(),
            ...
            a =
              e.top +
              (self.pageYOffset || (h.boxModel && r.scrollTop) || n.scrollTop) -
              i,
            s =
              e.left +
              (self.pageXOffset ||
                (h.boxModel && r.scrollLeft) ||
                n.scrollLeft) -
              o;
          return { top: a, left: s };
        })
      : (h.fn.offset = function () {
          ...
          for (
            var e,
              ...
              a = i.body,
              s = i.defaultView,
              l = s.getComputedStyle(t, null),
              c = t.offsetTop,
              u = t.offsetLeft;
            (t = t.parentNode) && t !== a && t !== o;

          )
            (e = s.getComputedStyle(t, null)),
              (c -= t.scrollTop),
              (u -= t.scrollLeft),
              t === n &&
                ((c += t.offsetTop),
                (u += t.offsetLeft),
                !h.offset.doesNotAddBorder ||
                  (h.offset.doesAddBorderForTableAndCells &&
                    /^t(able|d|h)$/i.test(t.tagName)) ||
                  ((c += parseInt(e.borderTopWidth, 10) || 0),
                  (u += parseInt(e.borderLeftWidth, 10) || 0)),
                (r = n),
                (n = t.offsetParent)),
              h.offset.subtractsBorderForOverflowNotVisible &&
                "visible" !== e.overflow &&
                ((c += parseInt(e.borderTopWidth, 10) || 0),
                (u += parseInt(e.borderLeftWidth, 10) || 0)),
              (l = e);
    ...
    (h.offset = {
      initialize: function () {
        if (!this.initialized) {
          ...
          (a.innerHTML = l),
            ...
            (this.doesNotIncludeMarginInBodyOffset = 0 === o.offsetTop),
            (o.style.marginTop = s),
            o.removeChild(a),
            (this.initialized = !0);
        }
      ...
      bodyOffset: function (e) {
        ...
        var t = e.offsetTop,
          n = e.offsetLeft;
        return (
          h.offset.doesNotIncludeMarginInBodyOffset &&
            ((t += parseInt(h.curCSS(e, "marginTop", !0), 10) || 0),
            (n += parseInt(h.curCSS(e, "marginLeft", !0), 10) || 0)),
          { top: t, left: n }
        );
      },
    }),
        ...
        if (this[0]) {
          var t = this.offsetParent(),
            ...
            i = /^body|html$/i.test(t[0].tagName)
              ? { top: 0, left: 0 }
              : t.offset();
          (r.top -= n(this, "marginTop")),
            (r.left -= n(this, "marginLeft")),
            (i.top += n(t, "borderTopWidth")),
            (i.left += n(t, "borderLeftWidth")),
            (e = { top: r.top - i.top, left: r.left - i.left });
        }
        return e;
      },
      ...
      h.fn[n] = function (t) {
        return this[0]
          ? t !== c
            ...
            : this[0] == u || this[0] == document
            ? self[e ? "pageYOffset" : "pageXOffset"] ||
              (h.boxModel && document.documentElement[n]) ||
              document.body[n]
            : this[0][n]
          : null;
      };
    ...
    h.each(["Height", "Width"], function (e, t) {
      ...
      (h.fn["inner" + t] = function () {
        ...
        (h.fn["outer" + t] = function (e) {
          return this[0]
            ? h.css(this[0], n, !1, e ? "margin" : "border")
            : null;
        });
      var r = t.toLowerCase();
      h.fn[r] = function (e) {
        return this[0] == u
          ? ("CSS1Compat" == document.compatMode &&
              ...
              document.body["client" + t]
          : this[0] == document
          ? Math.max(
              document.documentElement["client" + t],
              document.body["scroll" + t],
              document.documentElement["scroll" + t],
              document.body["offset" + t],
              document.documentElement["offset" + t]
            )
          : e === c
          ? this.length
            ? h.css(this[0], r)
            : null
          : this.css(r, "string" == typeof e ? e : e + "px");
      };
    });
})();
